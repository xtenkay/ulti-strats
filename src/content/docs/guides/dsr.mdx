...
:::caution[Cauterize]
The pyretic in Cauterize snapshots VERY early, make sure you hit escape (circle on controller) TWICE. If you still have the boss it can proc the pyretic even if you dont press an action.
:::
