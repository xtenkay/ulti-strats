...
:::note[Tessan]
This guide is based on EU strats but it is a very good visual guide for the mechanics so if you use it make sure you only use it as a base for learning and not for the actual strats!
