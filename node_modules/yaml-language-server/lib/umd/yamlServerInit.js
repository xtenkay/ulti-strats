(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver", "vscode-uri", "./commands", "./languageserver/commandExecutor", "./languageserver/handlers/languageHandlers", "./languageserver/handlers/notificationHandlers", "./languageserver/handlers/requestHandlers", "./languageserver/handlers/settingsHandlers", "./languageserver/handlers/validationHandlers", "./languageserver/handlers/workspaceHandlers", "./languageservice/services/yamlCommands", "./languageservice/utils/paths", "./languageservice/yamlLanguageService"], factory);
    }
    ...
    class YAMLServerInit {
        constructor(connection, yamlSettings, workspaceContext, schemaRequestService, telemetry, setupl10nBundle = () => Promise.resolve()) {
            this.connection = connection;
            this.yamlSettings = yamlSettings;
            this.workspaceContext = workspaceContext;
            this.schemaRequestService = schemaRequestService;
            this.telemetry = telemetry;
            this.setupl10nBundle = setupl10nBundle;
