...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs", "vscode-languageserver/node", "./languageserver/telemetry", "./languageservice/services/schemaRequestHandler", "./languageservice/utils/objects", "./nodeTranslationSetup", "./yamlServerInit", "./yamlSettings"], factory);
    }
    ...
    const nodeTranslationSetup_1 = require("./nodeTranslationSetup");
    ...
    const schemaRequestHandlerWrapper = (connection, uri) => {
        return (0, schemaRequestHandler_1.schemaRequestHandler)(connection, uri, yamlSettings.workspaceFolders, yamlSettings.workspaceRoot, yamlSettings.useVSCodeContentRequest, fileSystem, false);
    };
    const schemaRequestService = schemaRequestHandlerWrapper.bind(this, connection);
    const telemetry = new telemetry_1.TelemetryImpl(connection);
    new yamlServerInit_1.YAMLServerInit(connection, yamlSettings, schemaRequestHandler_1.workspaceContext, schemaRequestService, telemetry, nodeTranslationSetup_1.setupl10nBundle).start();
});
