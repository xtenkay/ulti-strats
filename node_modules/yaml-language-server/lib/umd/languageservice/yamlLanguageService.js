...
(function (factory) {
    ...
    const yamlRename_1 = require("./services/yamlRename");
    var SchemaPriority;
    ...
    function getLanguageService(params) {
        const schemaService = new yamlSchemaService_1.YAMLSchemaService(params.schemaRequestService, params.workspaceContext, null, params.yamlSettings);
        ...
        const yamlRename = new yamlRename_1.YamlRename(params.telemetry);
